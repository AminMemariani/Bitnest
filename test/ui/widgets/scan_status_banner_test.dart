...
void main() {
  group('ScanStatusBanner', () {
    testWidgets('idle state renders nothing visible', (t) async {
      ...
      expect(
          find.byKey(const Key('scan_status_banner_scanning')), findsNothing);
      expect(find.byKey(const Key('scan_status_banner_error')), findsNothing);
    });
    ...
    testWidgets('scanning state shows a progress indicator and label',
      ...
      expect(
          find.byKey(const Key('scan_status_banner_scanning')), findsOneWidget);
    ...
    testWidgets(
      ...
      expect(find.byKey(const Key('scan_status_banner_error')), findsOneWidget);
      expect(find.text('Network timeout while scanning UTXOs'), findsOneWidget);
